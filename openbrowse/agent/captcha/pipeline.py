...
from openbrowse.agent.captcha import client
from openbrowse.agent.captcha.base import Detection, SolveContext, _first_present
from openbrowse.agent.captcha.registry import detect_captcha
