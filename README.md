...
The same real-world extraction task (a careers page with 14 records behind an embedded, cross-origin board, full schema output) run against BU Cloud and against OpenBrowse on a Raspberry Pi 5 (16GB) without concurrency, ordered best to worst:
...
| OpenBrowse | claude-opus-5 | medium | TBD | TBD | TBD | TBD | TBD |
| OpenBrowse | gpt-5.6-sol | medium | TBD | TBD | TBD | TBD | TBD |
